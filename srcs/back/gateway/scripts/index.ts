...
fastify.register(fastifyProxy, {
	...
	rewritePrefix: '/api/auth' // on retire le prefixe avant de l'envoyer un service
});
...
fastify.register(fastifyProxy, {
	...
	rewritePrefix: '/api/chat' // on retire le prefixe avant de l'envoyer un service
});
...
fastify.register(fastifyProxy, {
	...
	rewritePrefix: '/api/game' // on retire le prefixe avant de l'envoyer un service
});
...
fastify.register(fastifyProxy, {
	...
	rewritePrefix: '/api/user' // on retire le prefixe avant de l'envoyer un service
});
